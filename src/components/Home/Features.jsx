...
const Features = () => {
  return (
    <div
      id="features"
      className="p-10 scroll-mt-12 flex flex-col items-center my-10"
    >
      ...
      <div className="flex items-center justify-center flex-wrap gap-6 mt-20 px-4 md:px-0">
        <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 border border-violet-200 hover:bg-violet-200 gap-6 max-w-sm">
        ...
        <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 border border-green-200 hover:bg-green-200 gap-6 max-w-sm">
        ...
        <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 border border-orange-200 hover:bg-orange-200 gap-6 max-w-sm">
